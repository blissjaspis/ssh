...
# download script
cd /usr/bin
wget -O menu "http://fira.cf/menu.sh"
wget -O usernew "http://fira.cf/usernew.sh"
wget -O trial "http://fira.cf/trial.sh"
wget -O hapus "http://fira.cf/hapus.sh"
wget -O cek "http://fira.cf/user-login.sh"
wget -O member "http://fira.cf/user-list.sh"
wget -O resvis "http://fira.cf/resvis.sh"
wget -O speedtest "http://fira.cf/speedtest_cli.py"
wget -O info "http://fira.cf/info.sh"
wget -O about "http://fira.cf/about.sh"
